...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSpinner3(){
        List<String> gajiList = new ArrayList<>();
        for(int i=1;i<=999;i+=2){
            gajiList.add("Bilangan ke-"+i);
        }
        ArrayAdapter<String> arrayAdapter3 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,gajiList);
